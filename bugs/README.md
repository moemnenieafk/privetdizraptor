...
- [[bugs/2026-09-02-2137--assets-r2-blocked-in-russia.md]] — 🚨 БЛОКЕР Ассеты: у RU-пользователей не грузятся карты и картинки (`in-progress` — диагноз есть: ТСПУ режет `r2.dev` по SNI; код готов, ждёт привязки `cdn.cta.quest` + редеплоя)
