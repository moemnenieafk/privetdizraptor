...
- [[bugs/2026-09-02-2137--assets-r2-blocked-in-russia.md]] — Ассеты/RU: блокировки НЕТ (замер с московского канала чистый). Настоящая поломка — расщеплённое делегирование NS, вылечена. (`triaged` — ждёт подтверждения от жаловавшихся в TG)
