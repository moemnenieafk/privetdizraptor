// cta-mapper — материальная палитра «Завод» (V4DYA, 2026-08-13) и логика сабсета.
//
...
/** 20 семейств × shadow/default/highlight = 60 цветов. */
...
export const COLLISION_GROUPS: string[][] = [
  ['veh-khaki', 'swamp', 'dirt', 'soil', 'veh-green', 'cnt-green'], // тёмно-зелёные/бурые
