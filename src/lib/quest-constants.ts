...
// на него завязан отдельный трекер /eft/quests/collector, кросс-линки на него живут в карточке квеста
// (QuestNode) и в детали ноды карты заданий (QuestDetail).
export const COLLECTOR_QUEST_ID = '5c51aac186f77432ea65c552';
export const COLLECTOR_TRACKER_HREF = '/eft/quests/collector';
