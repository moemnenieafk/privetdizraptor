...
// Модалка-предупреждение полного сброса схрона (дизайн 1:1 с NeededResetModal).
...
export function StashResetModal({ isOpen, onClose, onConfirm }: Props) {
        ...
        <div className="relative flex w-full flex-col items-center overflow-hidden rounded-b border border-danger bg-(--color-base) px-8 py-6 text-center">
          ...
          <div className="relative z-10 flex w-full flex-col items-center gap-5">
            ...
            <div className="flex flex-col gap-3 text-left text-xs font-blender-medium leading-relaxed text-text-secondary">
              <p>Очистить весь схрон?</p>
              <p>
                Будет обнулено: <span className="text-text-primary">всё владение предметами</span> — счётчики
                во всех разделах (модули убежища, крафты, важные предметы).
              </p>
              <p className="text-text-muted">
                Уровни убежища и выполненные задания останутся без изменений.
              </p>
            </div>
