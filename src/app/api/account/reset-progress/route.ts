...
// DESTRUCTIVE + необратимо. Пользователь ТОЛЬКО из сессии. Чистит 3 таблицы юзер-прогресса:
// quest_progress / barter_progress / player_profiles. Прогресс убежища — только localStorage
