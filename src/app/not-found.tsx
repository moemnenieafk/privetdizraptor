  ...
  return (
    <main className="flex w-full flex-col items-center justify-center pt-20 pb-25 animate-[fade-in_0.5s_ease-out_both] min-h-[70vh]">
      <div className="w-full max-w-[800px] px-4 flex flex-col items-center text-center">
        ...
        <p className="text-text-secondary max-w-md text-sm md:text-base font-blender-book mb-10">
        ...
        <Link 
          href="/eft"
          className="group relative inline-flex items-center justify-center px-8 py-3 bg-card-menu border border-lines-hover rounded-md overflow-hidden transition-all duration-300 hover:border-(--primary) hover:shadow-[0_0_15px_rgba(230,142,37,0.2)]"
        >
          <div className="absolute inset-0 w-0 bg-(--primary) transition-all duration-300 ease-out group-hover:w-full opacity-10"></div>
          <span className="relative z-10 text-text-primary group-hover:text-(--primary) font-blender-medium uppercase tracking-widest transition-colors duration-300">
            Вернуться в хаб
          </span>
        </Link>
