...
const KORD_BREACH: CuratedBuild[] = [
  ...
  },
  {
    ...
    tagline: 'Ноль позитивных, вся боль разом — 49 очков в никуда. Даже пострадать по полной не выйдет: два дебафа не уживаются друг с другом, один всегда за бортом. Награда — только право хвастаться в чате.',
    vibe: 'pain',
    perks: [
      'no-flea-market',
      'incompetent',
  ...
  },
  {
    ...
    name: 'Босая пехота',
    tagline: 'Брони у торговцев не достать — значит броня это ноги. Не ломаешься, прёшь как лось, крадёшься по кустам без шума, таскаешь железо Геркулесом. Барахолки и разгрузки нет: что нашёл — выносишь на себе.',
    vibe: 'speed',
    perks: [
      'sturdy-bones',
      'marathon-runner',
