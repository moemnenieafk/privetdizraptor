...
// Блок предмета ~32% роста Егеря (Егерь ~1400px во фрейме 3840×2867 → ~234px на канвасе 640×480).
// Приоритет — читаемость. Относительные размеры между предметами — padding'ом внутри 512²-блоков.
