...
// Блок предмета ~29% роста Егеря (Егерь ~1400px во фрейме 3840×2867 → ~234px на канвасе 640×480).
// Крупнее «натуральных» ¼ ради читаемости на мобилке. Относительные размеры — padding'ом внутри 512².
export const ITEM_SIZE = 68;
