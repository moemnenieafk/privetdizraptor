...
// Замер V4DYA под вьюпорт 640×480 с исходником 512² → блок 87px. Относительные размеры между
// предметами задаются padding'ом внутри 512²-блоков.
export const ITEM_SIZE = 87;
