  ...
  return (
    <>
      <button
        ...
        className="fixed right-0 top-40 z-60 flex items-center gap-2 rounded-l border border-r-0 border-lines-hover py-2 pr-2 pl-3 shadow-lg backdrop-blur-sm transition-all duration-300
