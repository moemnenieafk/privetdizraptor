...
// Генерик «Сброс прогресса домена»: danger-кнопка + модалка-предупреждение (стиль
// ProfileResetModal: красная шапка, warning-панель, ДА/НЕТ). Один механизм на все
// домены трекинга: достижения / задания / предметы. Текст тела — children.
    ...
    >
      ...
      >
        ...
        <div className="relative flex h-7 w-full items-center justify-start gap-1 rounded-t bg-danger">
          ...
          <div className="text-sm font-blender-medium leading-4 text-zinc-100">{title}</div>
