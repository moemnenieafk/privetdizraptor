        ...
        <div className="flex flex-col gap-4 border-t border-lines-hover pt-4 md:flex-row md:items-center">
          <div className="flex w-full items-center gap-6 md:w-auto">
            <div className="flex w-full flex-col gap-2 md:w-32">
              <span className="font-blender-medium text-type-caption text-text-muted">Мин: {filters.minClass}</span>
              <input
                type="range"
                min="1"
                max="6"
            ...
            <div className="flex w-full flex-col gap-2 md:w-32">
              <span className="font-blender-medium text-type-caption text-text-muted">Макс: {filters.maxClass}</span>
              <input
                type="range"
                min="1"
                max="6"
