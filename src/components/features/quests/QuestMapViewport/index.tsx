...
// Кламп зума-аута: куллинг questmap рендерит одну колонку (~60 нод), поэтому глубокий зум-аут
// в 0.05 = одинокая колонка в пустоте (+ страховка от лага на тяжёлых наборах). 0.1 тянет самую
// высокую колонку целиком, но не улетает в войд.
const ZOOM_MIN  = 0.1;
const ZOOM_MAX  = 2.0;
