...
export function ScrollToTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-8 right-4 z-50 flex items-center gap-1.5 rounded border px-3 py-2 font-blender-medium text-xs uppercase tracking-widest shadow-lg backdrop-blur-sm transition-all duration-300 sm:right-8
