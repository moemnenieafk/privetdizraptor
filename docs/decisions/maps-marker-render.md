...
**Статус:** ⚪ отложено — эпик [[fix-maps]] закрыт (2026-07-01), задача в самостоятельном бэклоге. Направление решено (рендерим своё), но A/B + дизайн слоёв/легенды не выбраны, синканные типы во вьюере не отрисованы.
