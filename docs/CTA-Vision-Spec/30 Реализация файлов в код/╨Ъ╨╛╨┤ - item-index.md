---
title: Код - item-index
tags: [cta, vision, code, typescript]
status: parsed-clean
repo_path: src/lib/vision/item-index.ts
lines: 76
created: 2026-08-24
---
...
Индекс эталонов в памяти процесса. Фильтр по габаритам режет пространство поиска на порядок.
...
Сырой файл: `_src/src/lib/vision/item-index.ts`. Копируется в репозиторий по пути `src/lib/vision/item-index.ts`.
