...
- [[ideas/2026-08-28-1457--seasons-build-social-likes-comments.md]] — Сезоны: соц-элемент к сборкам перков (лайк/дизлайк + комментарии) (`planned` — ИСПОЛНЕНО в рабочем дереве, спека `docs/decisions/seasons-build-social.md`, ждёт live-verify+пуш)
- [[ideas/2026-08-23-0352--items-acquisition-cost-funnel.md]] — Предметы/Убежище: рекурсивная «воронка» оптимальной добычи предмета (бартер→крафт→инпуты) + топливо-тумблеры калькулятора биткоин-фермы (`new`, важно · L)
